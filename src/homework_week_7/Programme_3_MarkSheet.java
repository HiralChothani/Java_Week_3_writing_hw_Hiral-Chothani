 ...
 * (Marks is between 0 to 100 and if it is out of range print error message "Invalid Input, Marks should be
 * between 0 to 100") and find out total, percentage and result. If he is pass or fail on the basis of percentage
 * (pass>=35) and also give them grade if % >= 80 A+. % >= 50 B, % >= 35 C And print marksheet in following format
 * | |
 *  * | Mark Sheet |
...
// Calculating the sum
    ...
    // CAlculating the grade on perccentage and result
