 ...
 * This month needs to return the number of Days in the month. Be careful about leap years
 * they have 29 dyas in month 2(February).
 ...
 * ● getDaysInMonth(2, 2018); should return 28 since February has 28 days if it's not s leap year and
 * 2018 is not a leap year.
 * ● getDaysInMonth(-1, 2020); should return -1 since the parameter month is invalid.
 * ● getDaysInMonth(1, -2020); should return -1 since the parameter year is outside the range of 1 to 9999
 * HINT: Use the switch statement.
 * NOTE: Metohds isLeapYear and getDaysInMonth need to be public static
 */
